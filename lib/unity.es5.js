  ...
  _createClass(Unity, [{
    ...
    */
    value: function get(path, context) {
      ...
      return new promise(function (r) {
        return r(_this2.resolvePath(path, 'get', context));
      });
      // return Promise.resolve(() => {
      //   this.resolvePath(path, 'get', context)
      // });
    ...
    */
    ...
    value: function set(path, value, context) {
      ...
      return new promise(function (r) {
        return r(_this3.resolvePath(path, 'set', context, value));
      });
    }
    ...
    */
    ...
    value: function add(path, value, context) {
      ...
      return new promise(function (r) {
        return r(_this4.resolvePath(path, 'add', context, value));
      });
    }
    ...
    */
    ...
    value: function del(path, context) {
      ...
      return new promise(function (r) {
        return r(_this5.resolvePath(path, 'del', context));
      });
    }
    ...
    */
    ...
    value: function inc(path, value, context) {
      ...
      return new promise(function (r) {
        return r(_this6.resolvePath(path, 'inc', context, value));
      });
    }
    ...
    */
    ...
    value: function dec(path, value, context) {
      ...
      return new promise(function (r) {
        return r(_this7.resolvePath(path, 'dec', context, value));
      });
    }
    ...
    */
    ...
    value: function cpy(path, dest, context) {
      ...
      return new promise(function (r) {
        return r(_this8.get(path, context));
      }).then(function (result) {
        return _this8.set(dest, result, context);
      });
    }
    ...
    */
    ...
    value: function mov(path, dest, context) {
      ...
      return new promise(function (r) {
        return r(_this9.get(path, context));
      }).then(function (result) {
        return _this9.set(dest, result, context);
      }).then(function (result) {
        return _this9.del(path, context);
      });
    }
    ...
    value: function addBinding(binding, bindingName) {
      ...
      if (typeof binding === 'object' && !binding.resolver) {
        return _.each(binding, function (r, n) {
          ...
          _this10.addBinding({ path: n, resolver: r }) :
          // Assume nested structure
          _this10.addBinding(r, n);
        });
      }
